...
class UserServiceTest {
    ...
    class createUser {
        ...
        void shouldCreateAUser() {
            ...
            //Act
            var userSaved = userService.createUser(newUser);
            ...
            assertEquals(newUser.username(), userCaptured.getUsername());
            assertEquals(newUser.email(), userCaptured.getEmail());
            assertEquals(newUser.password(), userCaptured.getPassword());
        }
        @Test
